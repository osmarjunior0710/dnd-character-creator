...
/* Bruxo/Pacto do Tomo tem 2 pares de lista que competem pelo MESMO nome
   ...
   de Bruxo). Cada lista passa a OUTRA como parte do `elsewhere` de
   spellChoiceList (ver comentário da função em 02-render-helpers.js) —
   nunca mais some da lista, só ganha ⚠️ se for escolhido nos dois ao
   mesmo tempo. */
function renderBruxoDetail(){
  ...
  <div class="intro" style="margin-bottom:8px;">Perícias que você já tem por outro recurso continuam aparecendo aqui — escolhê-las de novo não dá benefício extra, e vêm marcadas com ⚠️ pra você perceber e trocar se quiser.</div>
  ${groupedChoiceList(skillGroupsByAbility(BRUXO.skills), b.skills, 2, 'toggleBruxoSkill', skillsGrantedElsewhere('classe'))}
  ...
  ${spellChoiceList(BRUXO.cantrips, b.cantrips, 2, 'toggleCantrip', [...b.tomoCantrips, ...speciesGrantedCantrips(), ...chosenCantripsElsewhere('classe')])}
  ...
  ${spellChoiceList(ALL_CANTRIPS, b.tomoCantrips, 3, 'toggleTomoCantrip', [...b.cantrips, ...speciesGrantedCantrips(), ...chosenCantripsElsewhere('classe')])}
  ...
  ${spellChoiceList(BRUXO.spells1, b.spells1, 2, 'toggleSpell1', [...b.tomoRituals, ...speciesGrantedSpells(), ...chosenSpells1Elsewhere('classe')])}
  ...
  ${spellChoiceList(ALL_1ST_RITUAL, b.tomoRituals, 2, 'toggleTomoRitual', [...b.spells1, ...speciesGrantedSpells(), ...chosenSpells1Elsewhere('classe')])}
...
function renderBarbaroDetail(){
  ...
  <h3 id="grp-1-skills">Perícias (escolha 2)</h3>
  <div class="intro" style="margin-bottom:8px;">Perícias que você já tem por outro recurso continuam aparecendo aqui — escolhê-las de novo não dá benefício extra, e vêm marcadas com ⚠️ pra você perceber e trocar se quiser.</div>
  ${groupedChoiceList(skillGroupsByAbility(BARBARO.skills), bb.skills, 2, 'toggleBarbaroSkill', skillsGrantedElsewhere('classe'))}
...
function renderBardoDetail(){
  ...
  <div class="intro" style="margin-bottom:8px;">Perícias que você já tem por outro recurso continuam aparecendo aqui — escolhê-las de novo não dá benefício extra, e vêm marcadas com ⚠️ pra você perceber e trocar se quiser.</div>
  ${groupedChoiceList(skillGroupsByAbility(ALL_SKILLS), bd.skills, BARDO.skillsCount, 'toggleBardoSkill', skillsGrantedElsewhere('classe'))}
  ...
  ${speciesGrantedCantrips().length ? `<div class="intro" style="margin-bottom:8px;">Truques que você já conhece de graça pela espécie (${speciesGrantedCantrips().join(', ')}) continuam aparecendo aqui, marcados com ⚠️ se escolhidos de novo.</div>` : ''}
  ${spellChoiceList(BARDO.cantrips, bd.cantrips, 2, 'toggleBardoCantrip', [...speciesGrantedCantrips(), ...chosenCantripsElsewhere('classe')])}
  ...
  ${spellChoiceList(BARDO.spells1, bd.spells1, 4, 'toggleBardoSpell1', [...speciesGrantedSpells(), ...chosenSpells1Elsewhere('classe')])}
...
function renderMagoDetail(){
  ...
  <h3 id="grp-1-skills">Perícias (escolha 2)</h3>
  <div class="intro" style="margin-bottom:8px;">Perícias que você já tem por outro recurso continuam aparecendo aqui — escolhê-las de novo não dá benefício extra, e vêm marcadas com ⚠️ pra você perceber e trocar se quiser.</div>
  ${groupedChoiceList(skillGroupsByAbility(MAGO.skills), mg.skills, 2, 'toggleMagoSkill', skillsGrantedElsewhere('classe'))}
  ...
  ${speciesGrantedCantrips().length ? `<div class="intro" style="margin-bottom:8px;">Truques que você já conhece de graça pela espécie (${speciesGrantedCantrips().join(', ')}) continuam aparecendo aqui, marcados com ⚠️ se escolhidos de novo.</div>` : ''}
  ${spellChoiceList(MAGO.cantrips, mg.cantrips, MAGO.cantripsCount, 'toggleMagoCantrip', [...speciesGrantedCantrips(), ...chosenCantripsElsewhere('classe')])}
  ...
  ${spellChoiceList(MAGO.spells1, mg.spellbook, MAGO.spellbookCount, 'toggleMagoSpellbook', [...speciesGrantedSpells(), ...chosenSpells1Elsewhere('classe')])}
...
function renderPaladinoDetail(){
  ...
  <h3 id="grp-1-skills">Perícias (escolha 2)</h3>
  <div class="intro" style="margin-bottom:8px;">Perícias que você já tem por outro recurso continuam aparecendo aqui — escolhê-las de novo não dá benefício extra, e vêm marcadas com ⚠️ pra você perceber e trocar se quiser.</div>
  ${groupedChoiceList(skillGroupsByAbility(PALADINO.skills), pl.skills, 2, 'togglePaladinoSkill', skillsGrantedElsewhere('classe'))}
  ...
  ${spellChoiceList(PALADINO.spells1, pl.prepared, PALADINO.preparedCount, 'togglePaladinoPrepared', [...speciesGrantedSpells(), ...chosenSpells1Elsewhere('classe')])}
...
function renderPsionicoDetail(){
  ...
  <h3 id="grp-1-skills">Perícias (escolha 2)</h3>
  <div class="intro" style="margin-bottom:8px;">Perícias que você já tem por outro recurso continuam aparecendo aqui — escolhê-las de novo não dá benefício extra, e vêm marcadas com ⚠️ pra você perceber e trocar se quiser.</div>
  ${groupedChoiceList(skillGroupsByAbility(PSIONICO.skills), ps.skills, 2, 'togglePsionicoSkill', skillsGrantedElsewhere('classe'))}
  ...
  ${speciesGrantedCantrips().length ? `<div class="intro" style="margin-bottom:8px;">Truques que você já conhece de graça pela espécie (${speciesGrantedCantrips().join(', ')}) continuam aparecendo aqui, marcados com ⚠️ se escolhidos de novo.</div>` : ''}
  ${spellChoiceList(PSIONICO.cantrips, ps.cantrips, PSIONICO.cantripsCount, 'togglePsionicoCantrip', [...speciesGrantedCantrips(), ...chosenCantripsElsewhere('classe')])}
  ...
  ${spellChoiceList(PSIONICO.spells1, ps.spells1, PSIONICO.preparedCount, 'togglePsionicoSpell1', [...speciesGrantedSpells(), ...chosenSpells1Elsewhere('classe')])}
...
function renderClerigoDetail(){
  ...
  <h3 id="grp-1-skills">Perícias (escolha 2)</h3>
  <div class="intro" style="margin-bottom:8px;">Perícias que você já tem por outro recurso continuam aparecendo aqui — escolhê-las de novo não dá benefício extra, e vêm marcadas com ⚠️ pra você perceber e trocar se quiser.</div>
  ${groupedChoiceList(skillGroupsByAbility(CLERIGO.skills), cl.skills, 2, 'toggleClerigoSkill', skillsGrantedElsewhere('classe'))}
  ...
  ${speciesGrantedCantrips().length ? `<div class="intro" style="margin-bottom:8px;">Truques que você já conhece de graça pela espécie (${speciesGrantedCantrips().join(', ')}) continuam aparecendo aqui, marcados com ⚠️ se escolhidos de novo.</div>` : ''}
  ${spellChoiceList(CLERIGO.cantrips, cl.cantrips, cantripsMax, 'toggleClerigoCantrip', [...speciesGrantedCantrips(), ...chosenCantripsElsewhere('classe')])}
  ...
  ${spellChoiceList(CLERIGO.spells1, cl.spells1, CLERIGO.preparedCount, 'toggleClerigoSpell1', [...speciesGrantedSpells(), ...chosenSpells1Elsewhere('classe')])}
...
function renderGuerreiroDetail(){
  ...
  <h3 id="grp-1-skills">Perícias (escolha 2)</h3>
  <div class="intro" style="margin-bottom:8px;">Perícias que você já tem por outro recurso continuam aparecendo aqui — escolhê-las de novo não dá benefício extra, e vêm marcadas com ⚠️ pra você perceber e trocar se quiser.</div>
  ${groupedChoiceList(skillGroupsByAbility(GUERREIRO.skills), gr.skills, 2, 'toggleGuerreiroSkill', skillsGrantedElsewhere('classe'))}
...
function renderLadinoDetail(){
  ...
  <div class="intro" style="margin-bottom:8px;">Perícias que você já tem por outro recurso continuam aparecendo aqui — escolhê-las de novo não dá benefício extra, e vêm marcadas com ⚠️ pra você perceber e trocar se quiser.</div>
  ${groupedChoiceList(skillGroupsByAbility(LADINO.skills), ld.skills, LADINO.skillsCount, 'toggleLadinoSkill', skillsGrantedElsewhere('classe'))}
...
function renderDruidaDetail(){
  ...
  <h3 id="grp-1-skills">Perícias (escolha 2)</h3>
  <div class="intro" style="margin-bottom:8px;">Perícias que você já tem por outro recurso continuam aparecendo aqui — escolhê-las de novo não dá benefício extra, e vêm marcadas com ⚠️ pra você perceber e trocar se quiser.</div>
  ${groupedChoiceList(skillGroupsByAbility(DRUIDA.skills), dr.skills, 2, 'toggleDruidaSkill', skillsGrantedElsewhere('classe'))}
  ...
  ${speciesGrantedCantrips().length ? `<div class="intro" style="margin-bottom:8px;">Truques que você já conhece de graça pela espécie (${speciesGrantedCantrips().join(', ')}) continuam aparecendo aqui, marcados com ⚠️ se escolhidos de novo.</div>` : ''}
  ${spellChoiceList(DRUIDA.cantrips, dr.cantrips, cantripsMax, 'toggleDruidaCantrip', [...speciesGrantedCantrips(), ...chosenCantripsElsewhere('classe')])}
  ...
  <div class="intro" style="margin-bottom:8px;">Falar com Animais fica marcada com ⚠️ se escolhida aqui — você já tem ela sempre preparada de graça pelo Idioma Druídico, escolher de novo não dá benefício extra.</div>
  ${spellChoiceList(DRUIDA.spells1, dr.spells1, DRUIDA.preparedCount, 'toggleDruidaSpell1', ['Falar com Animais', ...speciesGrantedSpells(), ...chosenSpells1Elsewhere('classe')])}
...
function renderFeiticeiroDetail(){
  ...
  <h3 id="grp-1-skills">Perícias (escolha 2)</h3>
  <div class="intro" style="margin-bottom:8px;">Perícias que você já tem por outro recurso continuam aparecendo aqui — escolhê-las de novo não dá benefício extra, e vêm marcadas com ⚠️ pra você perceber e trocar se quiser.</div>
  ${groupedChoiceList(skillGroupsByAbility(FEITICEIRO.skills), ft.skills, 2, 'toggleFeiticeiroSkill', skillsGrantedElsewhere('classe'))}
  ...
  ${speciesGrantedCantrips().length ? `<div class="intro" style="margin-bottom:8px;">Truques que você já conhece de graça pela espécie (${speciesGrantedCantrips().join(', ')}) continuam aparecendo aqui, marcados com ⚠️ se escolhidos de novo.</div>` : ''}
  ${spellChoiceList(FEITICEIRO.cantrips, ft.cantrips, FEITICEIRO.cantripsCount, 'toggleFeiticeiroCantrip', [...speciesGrantedCantrips(), ...chosenCantripsElsewhere('classe')])}
  ...
  ${spellChoiceList(FEITICEIRO.spells1, ft.spells1, FEITICEIRO.preparedCount, 'toggleFeiticeiroSpell1', [...speciesGrantedSpells(), ...chosenSpells1Elsewhere('classe')])}
...
function renderMongeDetail(){
  ...
  <h3 id="grp-1-skills">Perícias (escolha 2)</h3>
  <div class="intro" style="margin-bottom:8px;">Perícias que você já tem por outro recurso continuam aparecendo aqui — escolhê-las de novo não dá benefício extra, e vêm marcadas com ⚠️ pra você perceber e trocar se quiser.</div>
  ${groupedChoiceList(skillGroupsByAbility(MONGE.skills), mk.skills, 2, 'toggleMongeSkill', skillsGrantedElsewhere('classe'))}
...
function renderGuardiaoDetail(){
  ...
  <div class="intro" style="margin-bottom:8px;">Perícias que você já tem por outro recurso continuam aparecendo aqui — escolhê-las de novo não dá benefício extra, e vêm marcadas com ⚠️ pra você perceber e trocar se quiser.</div>
  ${groupedChoiceList(skillGroupsByAbility(GUARDIAO.skills), gd.skills, GUARDIAO.skillsCount, 'toggleGuardiaoSkill', skillsGrantedElsewhere('classe'))}
  ...
  <div class="intro" style="margin-bottom:8px;">Sem truques no nível 1. Marca do Predador fica marcada com ⚠️ se escolhida aqui — você já tem ela sempre preparada de graça pelo Inimigo Favorito, escolher de novo não dá benefício extra.</div>
  ${spellChoiceList(GUARDIAO.spells1, gd.spells1, GUARDIAO.preparedCount, 'toggleGuardiaoSpell1', ['Marca do Predador', ...speciesGrantedSpells(), ...chosenSpells1Elsewhere('classe')])}
