  ...
  tracosFixos: [
    {
      ...
      resumo: "Você pode executar a ação Correr como uma Ação Bônus. Ao fazer isso, você adquire um número de Pontos de Vida Temporários igual ao seu Bônus de Proficiência. Você pode usar este traço um número de vezes igual ao seu Bônus de Proficiência, recuperando todos os usos ao completar um Descanso Curto ou Longo.",
      concede: []
    },
    {
      nome: "Vigor Implacável",
      resumo: "Ao ser reduzido a 0 Pontos de Vida, mas não morto imediatamente, você fica com 1 Ponto de Vida. Depois de usar este traço, você não pode usá-lo novamente até completar um Descanso Longo.",
      concede: []
    }
  ],
  subespecie: null
